...
transform = transforms.Compose([transforms.ToTensor()]) # transform the data to a tensor
mnist_train = datasets.MNIST( # train dataset
    root="./data", train=True, download=True, transform=transform
)
mnist_test = datasets.MNIST( # test dataset
...
# Remove mnist_data directory if it exists to update
if os.path.exists("mnist_data"):
    shutil.rmtree("mnist_data") # remove the directory
    print("Removed mnist_data directory")

# Remove MNIST raw data directory after processing to save space
